...
/**
 * Button that shows a white highlight overlay when hovered
...
public class HighlightButton extends EXButton {
    ...
    private static final ResourceLocation BLANK_TEXTURE = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/gui/screenshots/blank.png");

    @Override
    protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        if (isHovered) {
            RenderSystem.setShader(GameRenderer::getPositionColorShader);
            RenderSystem.setShaderTexture(0, BLANK_TEXTURE); // disable texture
