...
public class MenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ContainerArcaneTablet>> ARCANE_TABLET = Registry.register("arcane_tablet", 
        () -> IMenuTypeExtension.create(ContainerArcaneTablet::new));
