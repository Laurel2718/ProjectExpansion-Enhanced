...
public final class PacketHandler {
    ...
    public void register(PayloadRegistrar registrar) {
        registrar.playToServer(PacketArcaneTabletAction.TYPE, PacketArcaneTabletAction.STREAM_CODEC, IPacket::handle);
        registrar.playToServer(PacketArcaneTabletRecipeTransfer.TYPE, PacketArcaneTabletRecipeTransfer.STREAM_CODEC, IPacket::handle);
        ...
        registrar.playToClient(PacketRefreshArcaneTabletGUI.TYPE, PacketRefreshArcaneTabletGUI.STREAM_CODEC, IPacket::handle);
    }
    ...
    public static void sendToClient(net.minecraft.server.level.ServerPlayer player, IPacket packet) {
