...
public enum Lang implements ILangEntry {
    ...
    COLOR("text", "color"),
    MATTER("text", "matter"),
    SUN_LEVEL("text", "sun_level"),
    SUN_BONUS("text", "sun_bonus"),
    ALCHEMICAL_COLLECTION("text", "alchemical_collection"),
    FILTER_STATUS("text", "filter_status"),
    EMC_PER_SECOND("text", "emc_per_second"),
    EMC_STORAGE("text", "emc_storage"),
    EMC_TRANSFER_RATE("text", "emc_transfer_rate"),
    CHARGE_RATE("text", "charge_rate"),
    RELAY_BONUS("text", "relay_bonus"),
    EMC_IMPORT_LIMIT("text", "emc_import_limit"),
    ITEM_EXPORT_LIMIT("text", "item_export_limit"),
    ITEM_IMPORT_LIMIT("text", "item_import_limit"),
    FLUID_EXPORT_LIMIT("text", "fluid_export_limit"),
    FLUID_EXPORT_EFFICIENCY("text", "fluid_export_efficiency"),
    EMC_LIMIT("text", "emc_limit"),
    OWNER("text", "owner"),
    ...
    public enum Blocks implements ILangEntry {
        ...
        CONDENSER_MK3_TOOLTIP2("condenser_mk3", "tooltip"),
